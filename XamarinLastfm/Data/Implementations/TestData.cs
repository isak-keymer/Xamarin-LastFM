...
namespace XamarinLastfm
{
	public class TestData : IMusicRepository
	{
		...
		public  Task<IEnumerable<ArtistTopAlbum>> GetAlbumsForArtist (string artistName)
		{
			throw new NotImplementedException ();
		}

		public  Task<IEnumerable<SearchedAlbum>> SearchAlbums (string album, int numberOfResults, int? page = null)
		{
			throw new NotImplementedException ();
		}
